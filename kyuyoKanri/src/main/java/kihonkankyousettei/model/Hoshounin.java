...
public class Hoshounin {
	...
	public Hoshounin(Integer hoshounin_id, Integer shain_id, BigDecimal hoshou_kingaku, Date kaishi_nengappi,
	...
	public Hoshounin(Integer shain_id, BigDecimal hoshou_kingaku, Date kaishi_nengappi, Date shuuryou_nengappi,
			String hoshounin_mei, String kankei, String hoshounin_jumin_bangou, String hoshounin_denwa) {
		super();
		this.shain_id = shain_id;
		this.hoshou_kingaku = hoshou_kingaku;
		this.kaishi_nengappi = kaishi_nengappi;
