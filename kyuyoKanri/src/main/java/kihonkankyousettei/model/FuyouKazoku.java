...
public class FuyouKazoku {
	...
	public FuyouKazoku(Integer kazoku_id, Integer shain_id, String kankei, String namae, String kubun,
			String jumin_bangou, char shougaiUmu, char injinKoseiUmu, char kenkouHokenUmu, char doukyoUmu,
			char gakkunZeiUmu, char hatachiUmu) {
		super();
	...
	public FuyouKazoku(Integer shain_id, String kankei, String namae, String kubun, String jumin_bangou,
