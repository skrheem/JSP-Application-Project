...
public class KyuukaKoumoku {
	...
	public KyuukaKoumoku(String kyuukaShurui, Date tekiyouKaishi, Date tekiyouShuuryou, char shiyouUmu) {
		this.kyuukaShurui = kyuukaShurui;
		this.tekiyouKaishi = tekiyouKaishi;
		this.tekiyouShuuryou = tekiyouShuuryou;
		this.shiyouUmu = shiyouUmu;
	...
	public String toString() {
		return "KyuukaKoumoku{" + "kyuukaKoumoku_id=" + kyuukaKoumoku_id + ", kyuukaShurui='" + kyuukaShurui + '\''
				+ ", tekiyouKaishi=" + tekiyouKaishi + ", tekiyouShuuryou=" + tekiyouShuuryou + ", shiyouUmu="
				+ shiyouUmu + '}';
	}
}
